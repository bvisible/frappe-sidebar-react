  ...
  return /* @__PURE__ */ jsxs("div", { className: "nc-spa-panel", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "body", children: [
      ...
      state === "ready" && emails.map((e) => {
        ...
        return /* @__PURE__ */ jsxs("button", { className: cn("row", !e.seen && "unread"), onClick: onOpenWebmail, children: [
          /* @__PURE__ */ jsx2("span", { className: "dot" }),
    ...
    state === "ready" && /* @__PURE__ */ jsx2("div", { className: "foot", children: /* @__PURE__ */ jsxs("a", { className: "wiki", onClick: onOpenWebmail, style: { cursor: "pointer" }, children: [
...
function NeoCockpit({ env: envProp, onNavigate, homeUrl = "/app/home", onNora, onBell, onSynk, onHelp, defaultApp, surfaceApp, contextNav, contextFooter, onSearch, searchKbd, children, layout = "shell", className } = {}) {
  ...
  const sidebarBody = (forceExpanded = false) => {
    ...
    return /* @__PURE__ */ jsxs2(Fragment2, { children: [
      /* @__PURE__ */ jsxs2("div", { className: cn("nc-top nc-actions", !exp && !moreOpen && "nc-actions-folded"), children: [
        /* @__PURE__ */ jsx3("span", { className: "nc-logo-slot", children: /* @__PURE__ */ jsx3(LogoLink, { onClick: () => navigate(homeUrl), mark: false, height: exp ? 22 : 12 }) }),
  ...
  const flyoutNode = flyout ? /* @__PURE__ */ jsxs2("div", { className: "nc-flyout", style: { left: anchorLeft, top: Math.max(60, flyout.top - 8) }, children: [
  ...
  const panelsNode = showPanels ? /* @__PURE__ */ jsxs2("div", { className: "nc-spa-panel-anchor", style: { left: anchorLeft }, children: [
    ...
    openPanel === "favorites" && /* @__PURE__ */ jsx3(
      FavoritesPanel,
      {
        ...
        onRemove: (f) => {
          fetch("/api/method/neoffice_theme.cockpit_favorites.toggle_favorite?" + new URLSearchParams({ route: f.route }), { credentials: "include", headers: { "X-Frappe-Site-Name": window.location.hostname } }).then(() => window.dispatchEvent(new CustomEvent("nf-favorites-changed")));
        },
        onClose: () => setOpenPanel(null)
      }
    ),
