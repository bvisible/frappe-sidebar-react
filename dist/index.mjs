  ...
  const sidebarBody = (forceExpanded = false) => {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { className: "nc-top", children: [
        ...
        /* @__PURE__ */ jsx2("button", { className: "nc-iconbtn", title: tr("Ask NORA"), onClick: triggerNora, children: /* @__PURE__ */ jsx2(Sparkles, { size: 17, strokeWidth: 1.7, style: { color: "var(--nc-accent)" } }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "nc-search", onClick: (e) => e.currentTarget.querySelector("input")?.focus(), children: [
      ...
      /* @__PURE__ */ jsxs("nav", { className: "nc-nav", style: { marginTop: 4 }, children: [
          ...
          return /* @__PURE__ */ jsxs("div", { className: "nc-group", children: [
            ...
            open && /* @__PURE__ */ jsx2("div", { className: "nc-groupitems", children: items.map((ws) => {
              ...
              return /* @__PURE__ */ jsxs("button", { className: cn("nc-navitem", active && "active"), title: wsLabel, onClick: () => goWorkspace(ws), children: [
                /* @__PURE__ */ jsx2("span", { className: "ni", children: /* @__PURE__ */ jsx2(Icon, { size: 18, strokeWidth: 1.6 }) }),
                /* @__PURE__ */ jsx2("span", { className: "nl", children: wsLabel })
              ] }, ws.name);
            }) })
          ] }, app.app_name);
        }),
        allMode && !exp && appGroups.flatMap((g) => g.items).map((ws) => {
          ...
          const active = route.includes("/" + slug);
          const wsLabel = ws.label || tr(ws.title || ws.name);
          return /* @__PURE__ */ jsx2("button", { className: cn("nc-navitem", active && "active"), title: wsLabel, onClick: () => goWorkspace(ws), children: /* @__PURE__ */ jsx2("span", { className: "ni", children: /* @__PURE__ */ jsx2(Icon, { size: 19, strokeWidth: 1.6 }) }) }, ws.name);
        }),
