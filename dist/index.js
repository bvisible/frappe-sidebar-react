...
function NeoCockpit({ env: envProp, onNavigate, homeUrl = "/app/home", onNora, onBell, children, layout = "shell", className } = {}) {
  ...
  const [groupsCollapsed, setGroupsCollapsed] = (0, import_react.useState)(() => {
    try {
      return JSON.parse(localStorage.getItem("neocockpit-all-collapsed") || "{}");
    } catch {
      return {};
    }
  });
  ...
  const toggleGroup = (name) => {
    setGroupsCollapsed((prev) => {
      ...
      try {
        localStorage.setItem("neocockpit-all-collapsed", JSON.stringify(next));
      } catch {
      }
      return next;
    });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("nav", { className: "nc-nav", style: { marginTop: 4 }, children: [
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-group", children: [
            ...
            open && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "nc-groupitems", children: items.map((ws) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: cn("nc-navitem", active && "active"), title: wsLabel, onClick: () => goWorkspace(ws), children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ni", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Icon, { size: 18, strokeWidth: 1.6 }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "nl", children: wsLabel })
              ] }, ws.name);
            }) })
          ] }, app.app_name);
        }),
        allMode && !exp && appGroups.flatMap((g) => g.items).map((ws) => {
          ...
          const active = route.includes("/" + slug);
          const wsLabel = ws.label || tr(ws.title || ws.name);
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: cn("nc-navitem", active && "active"), title: wsLabel, onClick: () => goWorkspace(ws), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ni", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Icon, { size: 19, strokeWidth: 1.6 }) }) }, ws.name);
        }),
