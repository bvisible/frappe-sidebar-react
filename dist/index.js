  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-spa-panel", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "body", children: [
      ...
      state === "ready" && emails.map((e) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: cn("row", !e.seen && "unread"), onClick: onOpenWebmail, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dot" }),
    ...
    state === "ready" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "foot", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("a", { className: "wiki", onClick: onOpenWebmail, style: { cursor: "pointer" }, children: [
...
function NeoCockpit({ env: envProp, onNavigate, homeUrl = "/app/home", onNora, onBell, onSynk, onHelp, defaultApp, children, layout = "shell", className } = {}) {
  ...
  const sidebarBody = (forceExpanded = false) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "nc-logo-row", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LogoLink, { onClick: () => navigate(homeUrl), mark: !exp, height: exp ? 22 : 26 }) }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("nav", { className: "nc-nav", style: { marginTop: 4 }, children: [
        ...
        allMode && !exp && appGroups.map(({ app, items }) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
  ...
  const desktopAside = /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("aside", { className: sideClass, style: { width: expanded ? "var(--nc-w-expanded)" : "var(--nc-w-collapsed)" }, children: sidebarBody() });
  ...
  const tooltipNode = tip ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "nc-tooltip", style: { left: tip.x, top: tip.y }, children: tip.text }, tip.text + ":" + Math.round(tip.y)) : null;
  const showPanels = openPanel && (spaPanels || openPanel === "mailmenu" || openPanel === "mail");
  const panelsNode = showPanels ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "nc-spa-panel-anchor", style: { left: expanded ? 268 : 90 }, children: [
