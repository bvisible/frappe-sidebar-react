...
function NeoCockpit({ env: envProp, onNavigate, homeUrl = "/app/home", onNora, onBell, onSynk, onHelp, defaultApp, children, layout = "shell", className } = {}) {
  ...
  const [hiddenAlert, setHiddenAlert] = (0, import_react.useState)(false);
  const [openGroup, setOpenGroup] = (0, import_react.useState)("");
  ...
  const [formWidth, setFormWidth] = (0, import_react.useState)(() => boot?.user?.form_width || "Standard");
  ...
  const activeGroupName = (0, import_react.useMemo)(
  ...
  const switchFormWidth = (0, import_react.useCallback)((value) => {
    setFormWidth(value);
  ...
  const sidebarBody = (forceExpanded = false) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "nc-logo-row", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(LogoLink, { onClick: () => navigate(homeUrl), mark: !exp, height: exp ? 22 : 26 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: cn("nc-top nc-actions", !exp && !moreOpen && "nc-actions-folded"), children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "nc-iconbtn nc-nora", ...!exp ? tipProps(tr("Ask NORA")) : {}, title: exp ? tr("Ask NORA") : void 0, onClick: triggerNora, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.Sparkles, { size: 17, strokeWidth: 1.7 }) }),
        onSynk && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: "nc-iconbtn nc-synk", ...!exp ? tipProps(tr("Messages")) : {}, title: exp ? tr("Messages") : void 0, onClick: onSynk, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.Mail, { size: 17, strokeWidth: 1.7 }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "nc-count" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "nc-phone-slot", style: { display: "contents" } }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: "nc-iconbtn nc-bell", ...!exp ? tipProps(tr("Notifications")) : {}, title: exp ? tr("Notifications") : void 0, onClick: triggerBell, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.Bell, { size: 17, strokeWidth: 1.7 }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "pip nc-bell-pip" })
        ] }),
        onHelp && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: "nc-iconbtn nc-help", ...!exp ? tipProps(tr("Help & Training")) : {}, title: exp ? tr("Help & Training") : void 0, onClick: onHelp, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.LifeBuoy, { size: 17, strokeWidth: 1.7 }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "nc-count" })
        ] }),
        !forceExpanded && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.MoreHorizontal, { size: 17, strokeWidth: 1.7 }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: cn("pip nc-more-pip", hiddenAlert && "show") })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "relative" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: "nc-switch", ...!exp ? tipProps(allMode ? tr("All") : currentAppData?.app_title || tr("Switch module")) : {}, title: exp ? tr("Switch module") : void 0, onClick: () => setAppMenuOpen((o) => !o), children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "sq", children: allMode ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.LayoutGrid, { size: 17, strokeWidth: 1.6 }) : appLogoUrl ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: appLogoUrl, alt: "" }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.Briefcase, { size: 17, strokeWidth: 1.6 }) }),
          exp && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "meta nc-hide-collapsed", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "n", children: allMode ? tr("All") : currentAppData?.app_title || "ERPNext" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "s", children: allMode ? tr("All Modules") : tr("Active module") })
          ] }),
        ...
        appMenuOpen && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-menu", style: { top: "100%", left: 0, right: 0, marginTop: 4 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.LayoutGrid, { size: 16 }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { flex: 1 }, children: tr("All") })
              ]
            }
          ),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("nav", { className: "nc-nav", style: { marginTop: 4 }, children: [
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ni", children: app.app_logo_url ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: app.app_logo_url, alt: "", style: { width: 18, height: 18, objectFit: "contain" } }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.LayoutGrid, { size: 18, strokeWidth: 1.6 }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "nl", children: app.app_title })
                ]
              }
            ),
            groupActive && items.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "nc-sub", children: items.map((ws) => {
              const wsLabel = ws.label || tr(ws.title || ws.name);
              return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: cn("nc-subitem", isWsActive(ws) && "on"), title: wsLabel, onClick: () => goWorkspace(ws), children: wsLabel }, ws.name);
            }) })
          ] }, app.app_name);
        }),
        allMode && !exp && appGroups.map(({ app, items }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ni", children: app.app_logo_url ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: app.app_logo_url, alt: "", style: { width: 18, height: 18, objectFit: "contain" } }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.LayoutGrid, { size: 18, strokeWidth: 1.6 }) })
          },
          app.app_name
        )),
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "button",
            {
              ...
              children: [
                ...
                exp && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "nl", children: wsLabel })
              ]
            },
            ws.name
          );
      ...
      !forceExpanded && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "button",
        {
          ...
          children: [
            pinned ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.PanelLeftClose, { size: 16, strokeWidth: 1.7 }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.PanelLeftOpen, { size: 16, strokeWidth: 1.7 }),
            exp && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "nc-hide-collapsed", children: tr("Collapse menu") })
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-foot", style: { position: "relative" }, children: [
        userMenuOpen && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-menu", style: { bottom: "100%", left: 0, right: 0, marginBottom: 6 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-seg", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "lbl", children: tr("Width") }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: cn(formWidth === "Standard" && "on"), title: tr("Standard"), onClick: () => switchFormWidth("Standard"), children: "S" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: cn(formWidth === "Large" && "on"), title: tr("Large"), onClick: () => switchFormWidth("Large"), children: "M" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: cn(formWidth === "Full Width" && "on"), title: tr("Full Width"), onClick: () => switchFormWidth("Full Width"), children: "L" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "sep" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: "nc-user", title: exp ? userName : void 0, ...!exp ? tipProps(userName) : {}, onClick: () => setUserMenuOpen((o) => !o), children: [
  ...
  const mobileBar = /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-mobilebar", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nc-search", style: { margin: 0, flex: 1, maxWidth: 420 }, onClick: () => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { placeholder: tr("Search\u2026"), onKeyDown: env === "desk" ? void 0 : (e) => {
        if (e.key === "Enter") submitSearch(e.target.value);
      } })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "grow" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { className: "nc-iconbtn nc-bell", title: tr("Notifications"), onClick: triggerBell, children: [
  ...
  const tooltipNode = tip ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "nc-tooltip", style: { left: tip.x, top: tip.y }, children: tip.text }, tip.text + ":" + Math.round(tip.y)) : null;
  if (layout === "sidebar") {
