...
var FrappeSidebar = ({ defaultAppFilter, className, logoUrl } = {}) => {
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "p-2 relative", children: [
            ...
            appMenuOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "absolute left-2 right-2 top-14 bg-white border border-gray-200 rounded-lg shadow-lg z-50 py-1 max-h-80 overflow-y-auto", children: [
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-sm truncate", children: workspace.title || workspace.name })
                ]
              },
              workspace.name
            );
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "p-2 border-t border-gray-100", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.ArrowLeft, { className: "w-4 h-4", strokeWidth: 1.5 }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-sm", children: "Collapse" })
              ]
            }
          ) })
        ]
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-[50px] flex-shrink-0" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        className: cn(
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "p-2 border-t border-gray-100", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.ArrowRight, { className: "w-4 h-4", strokeWidth: 1.5 }),
                expanded && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-sm", children: "Collapse" })
              ]
            }
          ) })
        ]
