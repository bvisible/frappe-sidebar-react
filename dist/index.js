...
function NeoCockpit({ env: envProp, onNavigate, homeUrl = "/app/home", onNora, onBell, onSynk, onHelp, defaultApp, children, layout = "shell", className } = {}) {
  ...
  const sidebarBody = (forceExpanded = false) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: cn("nc-top nc-actions", !exp && !moreOpen && "nc-actions-folded"), children: [
        ...
        (onSynk || spaPanels) && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "button",
          {
  ...
  const panelsNode = spaPanels && openPanel ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "nc-spa-panel-anchor", style: { left: expanded ? 268 : 90 }, children: [
